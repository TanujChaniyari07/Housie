...
$sql1 =mysqli_query($con,"SELECT UserName FROM tbluser1 WHERE UserEmailId='$UserEmailId'");
$sql_result1 = mysqli_fetch_assoc($sql1);
$UserName= $sql_result1['UserName'];
...
$chat=$_POST['chat'];
$query=mysqli_query($con,"INSERT INTO tblchats (                 
     SocietyPin,chat,UserName,house_no) 
    VALUES('$SocietyPin','$chat','$UserName','$house_no')");
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Chats</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-12 mb-4 mb-lg-0">
            ...
            <?php 
$query=mysqli_query($con,"Select id,chat,CreationDate,UserName,house_no from  tblchats where SocietyPin='$SocietyPin'");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?> 
               
                  <h3 style="padding-top: 20px;">[<?php echo htmlentities($row['UserName']);?>] [<?php echo htmlentities($row['house_no']);?>] : <?php echo htmlentities($row['chat']);?> <sub> (<?php echo htmlentities($row['CreationDate']);?>)</sub></h3>
                     <?php
$cnt++;
 } ?>
                                        ...
                                        <div class="col-md-6" style="padding-top: 50px;">
                                            <form class="form-horizontal" name="category" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" value="" name="chat" required>
                                                    </div>
                                                </div>
                                                        <div class="form-group">
