      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Documents</h2>
        ...
        <div class="row">
            <?php 
$query=mysqli_query($con,"Select id,filename,naam from  tbl_files where Is_Active=1 AND SocietyPin='$SocietyPin'");
$cnt=1;
...
?> 
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <p><?php echo htmlentities($row['naam']);?></p>
            <p><a href="admin/postimages/<?php echo $row['filename']; ?>" target="_blank">View</a></p>
            <p><a href="admin/postimages/<?php echo $row['filename']; ?>" download>Download</a></p>
