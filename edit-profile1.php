...
<div class="wrap-input100 validate-input m-b-20" data-validate="UserEmailId">
					<input class="input100" type="text" name="UserEmailID1" value="<?php echo htmlentities($UserEmailId);?>">
					<span class="focus-input100"></span>

				</div>
				
				<div class="wrap-input100 validate-input m-b-20" data-validate="UserName">
					<input class="input100" type="text" name="UserName1" value="<?php echo htmlentities($UserName);?>">
					<span class="focus-input100"></span>

				</div>
<div class="wrap-input100 validate-input m-b-20" data-validate="SocietyPin">
					<input class="input100" type="text" name="SocietyPin1" value="<?php echo htmlentities($SocietyPin);?>">
					<span class="focus-input100"></span>
				</div>
				<div class="wrap-input100 validate-input m-b-20" data-validate="house_no">
					<input class="input100" type="text" name="house_no1" value="<?php echo htmlentities($house_no);?>">
					<span class="focus-input100"></span>
