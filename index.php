                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                <h2 data-animation="bounceInDown" data-delay="600ms" style="font-size: 40px;">DIGITIZE YOUR HOUSING SOCIETY TASKS WITH US</h2>
                                <p data-animation="bounceInDown" data-delay="500ms" style="padding-top: 20px;">Housie is a cloud based easy to use society management system which makes it easier for society to manage everyday affairs</p>
            ...
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(img/bg-img/Home_2_bg.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                <h2 data-animation="bounceInDown" data-delay="600ms" style="font-size: 40px;">Lots Of Features In One Software</h2>
                                <p data-animation="bounceInUp" data-delay="300ms">Features like Maintenance, Society polls and many more.</p>
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">TAKE A LOOK AT SOME AWESOME FEATURES</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="feature-1">
              ...
              <p>Quick and easy access to contact numbers of various service people .</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="feature-1">
              ...
              <h3>Announcement</h3>
              <p>Important statements issued by society management.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="feature-1">
              ...
              <h3>Society polls</h3>
              <p>Your opinion matters on various society affairs.</p>
            </div>
          </div>
        </div>
        <div class="row" style="padding-top: 20px;">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="feature-1">
              ...
              <p>Issue requests to society secretary to book society clubhouse/pool/etc.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="feature-1">
              ...
              <h3>Billing</h3>
              <p>Manage your society maintenance bills, issued fines, etc</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="feature-1">
              ...
              <h3>Chat Forum</h3>
              <p>Chat with all society members regarding important societal matters.</p>
            </div>
          </div>
        </div>
