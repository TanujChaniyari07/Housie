...
{
  $query2=mysqli_query($con,"Select oneq,twoq,threeq,fourq,oner,twor,threer,fourr from  tblpolls where poid='$id1' AND Is_Active=1 ");
$cnt2=1;
$ans=$_POST['ans'];
...
$query5=mysqli_query($con,"UPDATE tblpolls  
    SET oner = 1,twor=0,threer=0,fourr=0, Is_Active = 0
WHERE poid='$id1' AND oneq ='$ans'");



$query6=mysqli_query($con,"UPDATE tblpolls  
    SET oner = 0,twor=1,threer=0,fourr=0, Is_Active = 0
WHERE poid='$id1' AND twoq = '$ans'");



$query7=mysqli_query($con,"UPDATE tblpolls  
    SET oner = 0,twor=0,threer=1,fourr=0, Is_Active = 0
WHERE poid='$id1' AND threeq = '$ans'");



$query8=mysqli_query($con,"UPDATE tblpolls  
    SET oner = 0,twor=0,threer=0,fourr=1, Is_Active = 0
WHERE poid='$id1' AND fourq = '$ans'");
                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Society Polls</li>
                            </ol>
                        </nav>
                    </div>
                </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center">
          ...
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Polls</h2>
        ...
        <div class="row">
                              <?php 
$query=mysqli_query($con,"Select pollq,oneq,twoq,threeq,fourq,id from  tblpolls where poid='$id1' AND Is_Active=1 ");
$cnt=1;
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="feature-1">
              <span class="wrap-icon">
               ...
               <form class="form-horizontal" name="polls" method="post">
            <h3><?php echo htmlentities($row['pollq']);?></h3><BR>
            
  <div class="form-group">
    <select class="form-control" name="ans" id="ans" required>
<option value="">Select Answer </option>

<option value="<?php echo htmlentities($row['oneq']);?>"><?php echo htmlentities($row['oneq']);?></option>
<option value="<?php echo htmlentities($row['twoq']);?>"><?php echo htmlentities($row['twoq']);?></option>
<option value="<?php echo htmlentities($row['threeq']);?>"><?php echo htmlentities($row['threeq']);?></option>
<option value="<?php echo htmlentities($row['fourq']);?>"><?php echo htmlentities($row['fourq']);?></option>
