      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">ANNOUNCEMENTS</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-12 mb-4 mb-lg-0">
            ...
            <?php 
$query=mysqli_query($con,"Select * from  tblannouncements where Is_Active=1 AND SocietyPin='$SocietyPin'");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?> 
               
                  <h3 style="padding-top: 20px;"><?php echo htmlentities($row['Announcement']);?> (<?php echo htmlentities($row['date1']);?>)</h3>
                     <?php
$cnt++;
 } ?>
