...
$id1= $sql_result1['id'];
$sql2 =mysqli_query($con,"SELECT house_no FROM tbluser1 WHERE UserEmailId='$UserEmailId'");
$sql_result2 = mysqli_fetch_assoc($sql2);
$house_no= $sql_result2['house_no'];
$sql3 =mysqli_query($con,"SELECT UserName FROM tbluser1 WHERE UserEmailId='$UserEmailId'");
$sql_result3 = mysqli_fetch_assoc($sql3);
$UserName= $sql_result3['UserName'];
$UserEmailId = $_SESSION['login'];
...
{
    $rid=intval($_GET['rid']);
    $sql =mysqli_query($con,"delete from  tblcomplaint  where id='$rid'");
}
...
$query=mysqli_query($con,"INSERT INTO tblcomplaint (                 
     SocietyPin,complaint,Is_Active,chid,UserName,house_no) 
    VALUES('$SocietyPin','$complaint','$status','$id1','Anonymous','-')");
}
else
{
$query=mysqli_query($con,"INSERT INTO tblcomplaint (                 
     SocietyPin,Complaint,Is_Active,chid,UserName,house_no) 
    VALUES('$SocietyPin','$complaint','$status','$id1','$UserName','$house_no')");
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center">
          ...
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Your Complaints</h2>
        ...
        <div class="row">
                              <?php 
$query=mysqli_query($con,"Select * from  tblcomplaint where chid='$id1' AND Is_Active=1");
$cnt=1;
...
?> 
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <p>Complaint: <?php echo htmlentities($row['Complaint']);?></p>
            <p>Posting Date & Time: <?php echo htmlentities($row['CreationDate']);?></p>
            <p><a href="complaint.php?rid=<?php echo htmlentities($row['id']);?>&&action=app">Delete</a></p>
...
$cnt++;
  ...
  -->
    <div class="row justify-content-center text-center">
          ...
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Write a Complaint</h2>
                                        ...
                                        <div class="col-md-6">
                                            <form class="form-horizontal" name="category" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" value="" name="complaint" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
...
<label for="anon"> Remain Anonymous</label><br>
                                                    </div>
                                                </div>
