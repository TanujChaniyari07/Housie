...
$ToMin=$_POST['ToMin'];
$status=0;
$query=mysqli_query($con,"INSERT INTO tblclubhouse (                 
     SocietyPin,Name,Day,Month,Year,FromMin,ToMin,Is_Active,chid) 
    VALUES('$SocietyPin','$Name','$Day','$Month','$Year','$FromMin','$ToMin','$status','$id')");
...
$mail->Subject = 'Housie - New Clubhouse Request';
$mail->Body    = "A new clubhouse request has been made. Login to Housie to see.";
$mail->AltBody = "A new clubhouse request has been made. Login to Housie to see.";
$mail->send();
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center">
          ...
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Your Bookings</h2>
        ...
        <div class="row">
                              <?php 
$query=mysqli_query($con,"Select SocietyPin,Name,Day,Month,Year,FromMin,ToMin from  tblclubhouse where chid='$id' AND Is_Active=1");
$cnt=1;
...
?> 
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <p>Day: <?php echo htmlentities($row['Day']);?></p>
            <p>Month: <?php echo htmlentities($row['Month']);?></p>
            <p>Year: <?php echo htmlentities($row['Year']);?></p>
            <p>From: <?php echo htmlentities($row['FromMin']);?></p>
            <p>To: <?php echo htmlentities($row['ToMin']);?></p>
...
$cnt++;
  ...
  -->
    <div class="row justify-content-center text-center">
          ...
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Book Clubhouse</h2>
      
          </div>
        </div>
                                    <div class="row" style="padding-left: 410px;">
...
<option value="2030">2030</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" value="" name="FromMin" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">To</label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" value="" name="ToMin" required>
                                                    </div>
                                                </div>
        ...
        <div class="form-group">
                                                ...
                                                <button type="submit" class="btn alime-btn btn-2 mt-15" name="submit">
                                                    Submit
                                                </button>
                                                    </div>
                                                </div>
