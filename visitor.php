...
header('location:LoginSignUp.php');
    ...
    $sql =mysqli_query($con,"SELECT SocietyPin,house_no,UserName FROM tbluser1 WHERE UserEmailId='$UserEmailId'");
...
$sm = date("m");
$sy = date("Y");
if($_GET['action']=='app' && $_GET['rid'])
{
    $rid=intval($_GET['rid']);
    $sql =mysqli_query($con,"SELECT Name,Reason FROM tblvisitor WHERE id='$rid'");
$sql_result = mysqli_fetch_assoc($sql);
$Name1= $sql_result['Name'];
$Reason= $sql_result['Reason'];
    $query=mysqli_query($con,"update tblvisitor set Approved='Yes' where id='$rid'");
    $query4=mysqli_query($con,"Select AdminEmailID from  tbladmin1 where SocietyPin='$SocietyPin'");
$cnt4=1;
...
$mail->Username = 'housie370@gmail.com';                 // SMTP username
$mail->Password = 'mpstmepl@37';                           // SMTP password
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to

$mail->setFrom('housie370@gmail.com', 'Housie');

$mail->addAddress($row['AdminEmailID']);     // Add a recipient

              // Name is optional
$mail->addReplyTo('housie370@gmail.com', 'Housie');
   // Optional name
                                 // Set email format to HTML

$mail->Subject = 'Housie - Visitor Approved';
$mail->Body    = $UserName. "(".$house_no.") has approved the visitor - ".$Name1.".";
$mail->AltBody = $UserName. "(".$house_no.") has approved the visitor - ".$Name1.".";
$mail->send();

}
    
}
if($_GET['action']=='ua' && $_GET['cid'])
{
    $cid=intval($_GET['cid']);
    $sql =mysqli_query($con,"SELECT Name,Reason FROM tblvisitor WHERE id='$cid'");
$sql_result = mysqli_fetch_assoc($sql);
$Name1= $sql_result['Name'];
$Reason= $sql_result['Reason'];
    $query=mysqli_query($con,"update tblvisitor set Approved='No' where id='$cid'");
    $query4=mysqli_query($con,"Select AdminEmailID from  tbladmin1 where SocietyPin='$SocietyPin'");
$cnt4=1;
while($row=mysqli_fetch_array($query4))
{
...
$mail->Subject = 'Housie - Visitor Unapproved';
$mail->Body    = $UserName. "(".$house_no.") has unapproved the visitor - ".$Name1.".";
$mail->AltBody = $UserName. "(".$house_no.") has unapproved the visitor - ".$Name1.".";
$mail->send();
                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Visistor Management</li>
                            </ol>
                        </nav>
                    </div>
                </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Your Visitors</h2>
        ...
        <div class="row">
            <?php 
$query=mysqli_query($con,"Select * from  tblvisitor where Approved='Not Yet' AND house_no='$house_no'");
...
?> 
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <p><?php echo htmlentities($row['Reason']);?></p>
            <p><?php echo htmlentities($row['Time2']);?></p>
            <p><a href="visitor.php?rid=<?php echo htmlentities($row['id']);?>&&action=app">Approve</a></p>
            <p><a href="visitor.php?cid=<?php echo htmlentities($row['id']);?>&&action=ua">Unapprove</a></p>
...
$cnt++;
            ...
            <div class="row justify-content-center text-center">
          <div class="col-md-7 mb-5">
            <h2 style="padding-top: 50px;">Today's Visitor History</h2>
        ...
        <div class="row">
            <?php 
$query=mysqli_query($con,"Select * from  tblvisitor where house_no='$house_no' AND Date1='$sd' AND Month='$sm' AND Year='$sy' AND (Approved = 'Yes' OR Approved = 'No')");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?> 
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <p><?php echo htmlentities($row['Reason']);?></p>
            <p><?php echo htmlentities($row['Time2']);?></p>
            <p>Approved : <?php echo htmlentities($row['Approved']);?></p>
